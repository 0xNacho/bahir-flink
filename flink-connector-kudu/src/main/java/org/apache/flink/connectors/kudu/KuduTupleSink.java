...
/**
 * This class is in charge of inserting Flink java tuples in Kudu.
 *
 * @param <IN> Class extending from org.apache.flink.api.java.tuple.Tuple
 */
public class KuduTupleSink<IN extends Tuple> extends KuduSinkBase<IN> {
    public KuduTupleSink(KuduBaseOutputFormat.Conf conf) {
        super.conf = conf;
    }
